...
const PRIVESC_WINDOWS = [
  ...
  { id: "wp24a", text: "DLL HIJACK ENUM: Find non-system auto-start services + check writable dirs (M/W/F = vulnerable)", cmd: "wmic service get name,pathname,startmode | findstr /v /i \"C:\\Windows\" | findstr /i \"auto\" && for /f \"tokens=2 delims='='\" %a in ('wmic service get pathname /format:list ^| findstr /v /i \"C:\\Windows\" ^| findstr /i \":\\\\\"') do @icacls \"%~dpa\" 2>nul | findstr /i \"(M) (W) (F) Everyone Users BUILTIN\"" },
  { id: "wp24b", text: "DLL HIJACK ENUM: PowerUp automated scan — or if writable dir found, see docs/DLLHijacking.md for exploitation (cross-compile from Kali, no Windows machine needed)", cmd: "powershell -ep bypass -c \". .\\PowerUp.ps1; Find-ProcessDLLHijack; Find-PathDLLHijack\"" },
...
const AD_MS01_PRIVESC = [
  ...
  { id: "mp10a", text: "DLL HIJACK ENUM: Find non-system auto-start services + check writable dirs (M/W/F = vulnerable)", cmd: "wmic service get name,pathname,startmode | findstr /v /i \"C:\\Windows\" | findstr /i \"auto\" && icacls \"C:\\Program Files\\VulnApp\\\"" },
  { id: "mp10b", text: "DLL HIJACK ENUM: PowerUp automated scan — or if writable dir found, see docs/DLLHijacking.md for exploitation (cross-compile from Kali)", cmd: "powershell -ep bypass -c \". .\\PowerUp.ps1; Find-ProcessDLLHijack; Find-PathDLLHijack\"" },
